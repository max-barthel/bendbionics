...
describe("Input", () => {
  ...
  describe("Rendering", () => {
    ...
    it("renders with placeholder", () => {
      render(
        <Input value="" onChange={mockOnChange} placeholder="Enter text" />
      );
  ...
  describe("Edge Cases", () => {
    it("handles undefined value", () => {
      render(<Input value={undefined as any} onChange={mockOnChange} />);
    ...
    it("handles null value", () => {
      render(<Input value={null as any} onChange={mockOnChange} />);
